...
(function (MideaOperationalMode) {
    ...
    MideaOperationalMode[MideaOperationalMode["Auto"] = 1] = "Auto";
    MideaOperationalMode[MideaOperationalMode["Cooling"] = 2] = "Cooling";
    MideaOperationalMode[MideaOperationalMode["Dry"] = 3] = "Dry";
    MideaOperationalMode[MideaOperationalMode["Heating"] = 4] = "Heating";
    MideaOperationalMode[MideaOperationalMode["FanOnly"] = 5] = "FanOnly";
    MideaOperationalMode[MideaOperationalMode["CustomDry"] = 6] = "CustomDry"; // automatic dehumidification
