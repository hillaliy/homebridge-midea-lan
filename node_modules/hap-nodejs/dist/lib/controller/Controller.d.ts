 ...
 */
export declare type ControllerType = string | DefaultControllerType;
...
export declare type ControllerIdentifier = string | ControllerType;
export declare type StateChangeDelegate = () => void;
